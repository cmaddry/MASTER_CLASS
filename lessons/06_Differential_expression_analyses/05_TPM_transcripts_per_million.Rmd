...
# remove the first column called 'gene name' 
# Note: I had to add this
TPM <- TPM %>%
  select(-gene_name)
...
newwww_TEST <- TPM[rowSums(abs(TPM) < 1e-8) == ncol(TPM), ]
...
hist(TPM_not_zero$WT_0_1, xlim = c(0,50), breaks = 5000)
